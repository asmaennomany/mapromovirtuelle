...
<body id="page-top">
  ...
  <nav id="sidebar-wrapper">
    <ul class="sidebar-nav">
      ...
      <li class="sidebar-nav-item">
        <a class="js-scroll-trigger" href="etudiant.php">Etudiant</a>
      </li>
      <li class="sidebar-nav-item">
        <a class="js-scroll-trigger" href="profiles.php">Recruteur</a>
      </li>
    </ul>
  </nav>
  ...
  <header class="masthead d-flex">
    <div class="container text-center my-auto">
      ...
      <h3 class="mb-5">
        <em>Facilite le lien étudiant-entreprise!</em>
      </h3>
      <a class="btn btn-primary btn-xl js-scroll-trigger" href="etudiant.php">Etudiant</a>
      <a class="btn btn-primary btn-xl js-scroll-trigger" href="profiles.php">Recruteur</a>
    </div>
