...
<body id="page-top">
  ...
  <nav id="sidebar-wrapper">
    <ul class="sidebar-nav">
      ...
      <li class="sidebar-nav-item">
        <a class="js-scroll-trigger" href="#portfolio">Se connecter</a>
      </li>
      <li class="sidebar-nav-item">
        <a class="js-scroll-trigger" href="etudiant.php#creer">Créer un compte</a>
      </li>
    </ul>
  </nav>
  ...
  <header class="masthead d-flex">
    <div class="container text-center my-auto">
      <form action="verifier_auth.php" method="get">
        <input type="text" id="login" class="fadeIn second" name="login" placeholder="login">
        <input type="password" id="password" class="fadeIn third" name="passe" placeholder="password">
